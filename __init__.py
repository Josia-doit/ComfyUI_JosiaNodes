...
register_node("group_controller", "JosiaGroupControllerG", "Josia分组控制")
...
register_node("media_save", "JosiaMediaSave", "Josia媒体保存")
register_node("load_latent", "JosiaLoadLatent", "Josia加载Latent")
